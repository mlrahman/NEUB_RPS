...
<div id="result_popup" class="w3-modal">
	<div class=" w3-modal-content w3-round-large w3-animate-bottom w3-card-4 w3-leftbar w3-rightbar w3-bottombar w3-topbar w3-border-white">
		<header class="w3-container w3-black w3-bottombar w3-border-teal w3-round-top-large"> 
			<span onclick="document.getElementById('result_popup').style.display='none'" class="w3-button w3-display-topright w3-xlarge w3-hover-teal w3-round" style="padding:2px 12px;margin: 15px 10px;"><b>&times;</b></span>
		...
		<div class="w3-container w3-row w3-round-bottom-large w3-padding w3-border w3-border-teal" style="height:100%;">
			<div class="w3-container w3-padding-small" style="margin:0px;padding:0px;width:100%;min-height:200px;height:auto;">
				<p id="empty_result" class="w3-hide w3-text-red w3-center w3-xxxlarge">
					Sorry! No data available.
				</p>
				<p id="loading_result" title="Fetching result, please wait.." class="w3-hide w3-text-green w3-center w3-jumbo">
							...
							<div class="w3-rest w3-container w3-padding-0 w3-margin-0" style="min-width:200px;">
								<table>
									<tr>
										...
										<td valign="top" class="w3-bold">: Mir Lutfur Rahman</td>
									</tr>
									<tr>
										<td valign="top">Reg. No</td>
										<td valign="top" class="w3-bold">: 140203020002</td>
									</tr>
									<tr>
										<td valign="top">Session</td>
										<td valign="top">: Summer-2014</td>
									</tr>
									<tr>
					...
					<div class="w3-half w3-container w3-padding-0">
						<table>
							<tr>
								...
								<td valign="top" class="w3-bold">: B.Sc. (Engg.) in CSE</td>
							</tr>
							<tr>
								<td valign="top">Degree Credit</td>
								<td valign="top" class="w3-bold">: 160</td>
							</tr>
							<tr>
								<td valign="top">Credit Earned</td>
								<td valign="top" class="w3-text-green">: 160</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td valign="top" class="w3-text-red">: 3.95</td>
							</tr>
							<tr>
								<td valign="top">Degree Status</td>
								<td valign="top" class="w3-bold">: Completed</td>
							</tr>
						</table>
					</div>
				</div>
