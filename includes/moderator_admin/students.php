...
<div class="w3-container w3-margin-bottom">
	...
	<div class="w3-container w3-padding-0" style="margin:0px 0px 20px 0px;">
		...
		<button onclick="get_total_search_results8(0,0)" class="w3-button w3-brown w3-round-large w3-hover-teal w3-margin-left"><i class="fa fa-refresh"></i> Refresh</button>
	</div>
		...
		<div class="w3-container w3-margin-0 w3-padding-0"  id="student_multiple_add_box1">
			...
			<div class="w3-row w3-margin-top w3-margin-bottom w3-round-large w3-border w3-padding">
				<div class="w3-col w3-margin-0" style="width:70%;padding:0px 6px 0px 6px;">
					...
					<input class="w3-input w3-border w3-round-large w3-margin-bottom" type="file" id="student_excel_file" title="Please upload the formatted and filled up excel file."  onchange="student_multiple_add_form_change()">
...
<script>
	...
	function student_single_waive_add_form_save()
	{
		...
		else if(student_single_waive_add_pass_co_fu()==true)
		{
			...
			xhttp1.open("POST", "../includes/moderator_admin/add_single_waived_course.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&pass="+pass+"&student_id="+student_view_id+"&course_id="+student_view_course, true);
			xhttp1.send();
		}
	}
	...
	function student_multiple_waive_add_form_save()
	{
		...
		else if(student_multiple_waive_add_pass_co_fu()==true)
		{
			...
			xhttp1.open("POST", "../includes/moderator_admin/add_multiple_waive_course.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&excel="+link+"&pass="+pass, true);
	...
	function reload_dept8()
	{
		...
		load_program.open("GET", "../includes/moderator_admin/get_programs.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&dept_id="+dept_id, true);
		load_program.send();
	...
	function student_multiple_add_form_save()
	{
		...
		else if(student_multiple_add_pass_co_fu()==true)
		{
			...
			xhttp1.open("POST", "../includes/moderator_admin/add_multiple_students.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&excel="+link+"&pass="+pass+"&student_prog="+student_prog, true);
			xhttp1.send(fd_excel);
		}
	}
	...
	function student_single_add_form_save()
	{
		...
		else if(student_single_add_pass_co_fu()==true)
		{
			...
			xhttp1.open("POST", "../includes/moderator_admin/add_single_student.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&pass="+pass+"&student_name="+student_view_name+"&student_mobile="+student_view_mobile+"&student_email="+student_view_email+"&student_gender="+student_view_gender+"&student_id="+student_view_id+"&student_birth_date="+student_view_birth_date+"&student_prog="+student_view_prog+"&student_status="+student_view_status, true);
			xhttp1.send();
		}
	...
	function student_waive_form_save()
	{
		...
		else if(student_waive_pass_co_fu()==true)
		{
			...
			xhttp1.open("POST", "../includes/moderator_admin/add_student_waive_course.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&pass="+pass+"&student_waive_course="+student_waive_course+"&student_id="+student_view_id, true);
			xhttp1.send();
		}
	...
	function moderator_print_result(s_id,a_id)
	{
		window.open('../includes/moderator_admin/moderator_result_print.php?student_id='+s_id+'&moderator_id='+a_id);		
	}
	...
	function view_result8(student_id)
	{
		...
		search_window_result.open("GET", "../includes/moderator_admin/get_search_window_results8.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&student_id="+student_id, true);
	...
	function get_total_search_results8(x,y)
	{
		...
		total8_results.open("GET", "../includes/moderator_admin/get_total_search_results8.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&search_text="+search_text+"&filter_status="+filter_status8+"&filter_degree="+filter_degree8+"&dept_id="+dept_id8+"&prog_id="+prog_id8, true);
		total8_results.send();
	...
	function get_search_results8(x,y)
	{
		...
		if(total8!=0)
		{
			...
			search_results.open("GET", "../includes/moderator_admin/get_search_results8.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&search_results_from="+search_results_from+"&sort="+r_sort+"&search_text="+search_text+"&filter_status="+filter_status8+"&filter_degree="+filter_degree8+"&dept_id="+dept_id8+"&prog_id="+prog_id8, true);
			search_results.send();
		}
		else
		{
