<?php
	...
	if(isset($_REQUEST['filter_status']) && isset($_REQUEST['filter_semester']) && isset($_REQUEST['filter_grade'])  && isset($_REQUEST['filter_instructor']) && isset($_REQUEST['search_text']) && isset($_REQUEST['program_id']) && isset($_REQUEST['dept_id']) && isset($_REQUEST['moderator_id']) && $_REQUEST['moderator_id']==$_SESSION['moderator_id'])
	{
