<?php
	...
	if(isset($_REQUEST['program_id']) && isset($_REQUEST['recent_results_from']) && isset($_REQUEST['dept_id']) && isset($_REQUEST['moderator_id']) && $_REQUEST['moderator_id']==$_SESSION['moderator_id'])
	{
