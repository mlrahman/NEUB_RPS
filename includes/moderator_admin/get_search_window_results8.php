<?php
	...
	if(isset($_REQUEST['student_id']) && isset($_REQUEST['moderator_id']) && $_REQUEST['moderator_id']==$_SESSION['moderator_id'])
	{
		try{
...
?>
		...
		<div class="w3-container w3-row" style="height:100%;padding: 0px 12px 10px 12px;" id="student_view_box1" >
			<p class="w3-margin-0 w3-left w3-text-indigo w3-cursor" style="margin: 0px 12px 5px 0px;" onclick="document.getElementById('student_view_box1').style.display='none';document.getElementById('student_view_box2').style.display='none';document.getElementById('student_view_box5').style.display='block';"><i class="fa fa-pencil-square"></i> Modify Waived Courses</p>
							...
							<tr>
								...
								<td valign="top">
									<div class="w3-dropdown-hover w3-round-large w3-right">
										<button class="w3-button w3-black w3-round-large w3-hover-teal w3-padding-small" onclick="moderator_print_result('<?php echo password_encrypt($s_id.get_current_date()); ?>','<?php echo password_encrypt($_REQUEST['moderator_id'].get_current_date()); ?>')"><i class="fa fa-print"></i> Print</button>
			...
			<div class="w3-container w3-border w3-round-large w3-padding" style="margin: 0px 12px 12px 12px;">
				...
				<table style="width:100%;margin:5px 0px;" class="w3-border w3-round w3-border-black w3-topbar w3-bottombar">
					<tr class="w3-black w3-bold">
						<td colspan="3" class="w3-padding-small">Waived Courses</td>
