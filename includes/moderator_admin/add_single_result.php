<?php
	...
	if(isset($_REQUEST['pass']) && isset($_REQUEST['status']) && isset($_REQUEST['semester']) && isset($_REQUEST['remarks']) && isset($_REQUEST['student_id']) && isset($_REQUEST['marks']) && isset($_REQUEST['instructor_id']) && isset($_REQUEST['course_id']) && isset($_REQUEST['prog_id']) && isset($_REQUEST['moderator_id']) && $_REQUEST['moderator_id']==$_SESSION['moderator_id'])
	{
		try
		{
			...
			else
			{
				...
				if($result[0][2]!=$prog_id) //ambiguty check
				{
					echo 'unable6';
					die();
				}
