<?php
	...
	if(isset($_REQUEST['student_id']) && isset($_REQUEST['moderator_id']) && isset($_SESSION['student_id']) && $_REQUEST['student_id']==password_encrypt($_SESSION['student_id'].get_current_date()) && $_REQUEST['moderator_id']==password_encrypt($_SESSION['moderator_id'].get_current_date()))
	{
		...
		try{
			...
			$stmt->bindParam(':s_id', $s_id);
			$stmt->bindParam(':f_id', $moderator_id);
			$stmt->execute();
