...
<table style="width:100%;" class="w3-border w3-round w3-border-black w3-topbar w3-bottombar">
	<tr class="w3-teal w3-bold">
		<td style="width:18%;" valign="top" class="w3-padding-small">Semester</td>
		...
		<td style="width:27%;" valign="top" class="w3-padding-small">Course Title</td>
...
<script>
	...
	function get_total_recent_results(x)
	{
		...
		total_results.open("GET", "../includes/moderator_admin/get_total_results.php?dept_id="+dept_id+"&moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&program_id="+prog_id, true);
		total_results.send();
	}
	...
	function get_recent_results(x)
	{
		...
		if(total!=0)
		{
			...
			recent_results.open("GET", "../includes/moderator_admin/get_recent_results.php?dept_id="+dept_id+"&moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&recent_results_from="+recent_results_from+"&program_id="+prog_id, true);
			recent_results.send();
		}
		else
		{
