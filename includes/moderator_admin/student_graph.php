...
<div class="w3-container w3-margin-0 w3-padding-0" id="student_graph">
...
<script>
	...
	function get_student_graph()
	{
		...
		if(student_graph_to!="" || student_graph_from!="")
		{
			...
			document.getElementById('student_graph').innerHTML='<p class="w3-center" style="margin: 50px 0px 0px 0px;"><i class="fa fa-refresh w3-spin"></i> Please wait!! while loading...</p>';
			...
			student_graph.onreadystatechange = function() {
				if (this.readyState == 4 && this.status == 200) {
					...
					document.getElementById('student_graph').innerHTML='<canvas id="stu_stat" style="width:100%;height:260px;"><p class="w3-center" style="margin: 50px 0px 0px 0px;"><i class="fa fa-refresh w3-spin"></i> Please wait!! while loading...</p></canvas>';
			...
			student_graph.open("GET", "../includes/moderator_admin/get_student_graph.php?dept_id="+dept_id+"&moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&student_graph_from="+student_graph_from+"&student_graph_to="+student_graph_to+"&program_id="+prog_id, true);
			student_graph.send();
		}
	}
