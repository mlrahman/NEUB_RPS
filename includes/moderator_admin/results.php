...
<script>
	...
	function result_single_add_form_change()
	{
		...
		if(result_single_add_student_id.length==12)
		{
			...
			xhttp1.open("POST", "../includes/moderator_admin/get_result_single_add_student_name.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&student_id="+result_single_add_student_id+"&prog_id="+result_single_add_prog, true);
			xhttp1.send();
	...
	function result_single_add_program_change()
	{
		...
		if(result_single_add_prog!="")
		{
			...
			xhttp1.open("POST", "../includes/moderator_admin/get_result_single_add_courses.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&prog_id="+result_single_add_prog, true);
			xhttp1.send();
	...
	function result_multiple_add_program_change()
	{
		...
		if(result_multiple_add_prog!="")
		{
			...
			xhttp1.open("POST", "../includes/moderator_admin/get_result_single_add_courses.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&prog_id="+result_multiple_add_prog, true);
			xhttp1.send();
	...
	function result_multiple_add_form_save()
	{
		...
		else if(result_multiple_add_prog!="" && result_multiple_add_course!="" && result_multiple_add_course_instructor!="" && result_multiple_add_semester!="" &&  result_multiple_add_pass_co_fu()==true)
		{
			...
			xhttp1.open("POST", "../includes/moderator_admin/add_multiple_results.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&excel="+link+"&pass="+pass+"&prog_id="+result_multiple_add_prog+"&course_id="+result_multiple_add_course+"&instructor_id="+result_multiple_add_course_instructor+"&semester="+result_multiple_add_semester, true);
	...
	function view_result9(r_id)
	{
		...
		search_window_result.open("GET", "../includes/moderator_admin/get_search_window_results9.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&r_id="+r_id, true);
	...
	function get_total_search_results9(x,y)
	{
		...
		total9_results.open("GET", "../includes/moderator_admin/get_total_search_results9.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&search_text="+search_text+"&program_id="+prog_id+"&dept_id="+dept_id+"&filter_semester="+filter_semester+"&filter_grade="+filter_grade+"&filter_instructor="+filter_instructor+"&filter_status="+filter_status, true);
		total9_results.send();
	...
	function get_search_results9(x,y)
	{
		...
		if(total9!=0)
		{
			...
			search_results.open("GET", "../includes/moderator_admin/get_search_results9.php?moderator_id="+<?php echo $_SESSION['moderator_id']; ?>+"&search_results_from="+search_results_from+"&sort="+r_sort+"&search_text="+search_text+"&program_id="+prog_id+"&dept_id="+dept_id+"&filter_semester="+filter_semester+"&filter_grade="+filter_grade+"&filter_instructor="+filter_instructor+"&filter_status="+filter_status, true);
			search_results.send();
		}
		else
		{
