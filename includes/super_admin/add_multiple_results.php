<?php
	...
	if(isset($_REQUEST['semester']) && isset($_REQUEST['excel']) && isset($_REQUEST['pass']) && isset($_REQUEST['prog_id']) && isset($_REQUEST['instructor_id']) && isset($_REQUEST['course_id']) && isset($_REQUEST['admin_id']) && $_REQUEST['admin_id']==$_SESSION['admin_id'])
	{
		$excel_name='1';
