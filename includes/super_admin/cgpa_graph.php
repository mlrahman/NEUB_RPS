...
<script>
	...
	function get_student_cgpa()
	{
		...
		if(student_cgpa_to!="" || student_cgpa_from!="")
		{
			...
			student_cgpa.open("GET", "../includes/super_admin/get_student_cgpa.php?dept_id="+dept_id+"&admin_id="+<?php echo $_SESSION['admin_id']; ?>+"&student_cgpa_from="+student_cgpa_from+"&student_cgpa_to="+student_cgpa_to+"&program_id="+prog_id, true);
			student_cgpa.send();
		}
	}
