<?php
	...
	if(isset($_REQUEST['pass']) && isset($_REQUEST['status']) && isset($_REQUEST['semester']) && isset($_REQUEST['remarks']) && isset($_REQUEST['student_id']) && isset($_REQUEST['marks']) && isset($_REQUEST['instructor_id']) && isset($_REQUEST['course_id']) && isset($_REQUEST['prog_id']) && isset($_REQUEST['admin_id']) && $_REQUEST['admin_id']==$_SESSION['admin_id'])
	{
		try
		{
