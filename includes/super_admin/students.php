...
<div class="w3-container w3-margin-bottom">
	...
	<div id="search_window8" class="w3-container w3-topbar w3-leftbar w3-rightbar w3-bottombar w3-round-large w3-margin-bottom" style="display:none;">
		...
		<span onclick="print_student_view()" title="Print Window" class="w3-button w3-right w3-large w3-indigo w3-hover-teal w3-round" style="padding:2px 10px;margin: 15px 10px 0px 0px;"><i class="fa fa-print"></i></span>
	...
	<p class="w3-margin-0 w3-padding-0 w3-medium w3-left">Total Data: <span class="w3-text-red" id="search_data_label8"></span></p>		
	<p class="w3-margin-0 w3-padding-0 w3-medium w3-left w3-margin-left"><i class="fa fa-print w3-hover-text-teal w3-text-indigo w3-cursor" onclick="print_students()"> Print</i></p>		
	<div class="w3-clear"></div>
...
<script>
	...
	function print_students()
	{
		...
		window.open('../includes/super_admin/student_print.php?admin_id='+<?php echo $_SESSION["admin_id"]; ?>+'&sort='+r_sort+'&search_text='+search_text+'&filter_status='+filter_status8+'&filter_degree='+filter_degree8+'&dept_id='+dept_id8+'&prog_id='+prog_id8);		
	}
	
	function print_students_delete_history()
	{
		window.open('../includes/super_admin/student_delete_history_print.php?admin_id='+<?php echo $_SESSION["admin_id"]; ?>);		
	}
	
	function print_student_view() { 
		var divContents = document.getElementById("search_window8").innerHTML; 
