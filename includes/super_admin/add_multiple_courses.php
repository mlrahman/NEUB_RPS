					...
					foreach ( $xlsx->rows() as $r => $row ) {
						...
						if($course_status=='Active' || $course_status=='Inactive')
						{
							...
							else
							{
								...
								$task='Added Course Title: '.$course_title.', Course Code: '.$course_code.', Course Credit: '.number_format($course_credit,2).', Course Program: '.$prog_title.', Course Status: '.$course_status;
