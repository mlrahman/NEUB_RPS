...
?>		
		<p class="w3-margin-0 w3-padding-0 w3-medium"><i class="fa fa-print w3-hover-text-teal w3-text-indigo w3-cursor" onclick="print_admins_delete_history()"> Print</i></p>		
