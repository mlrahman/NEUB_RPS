...
<script>
	...
	function get_student_graph()
	{
		...
		if(student_graph_to!="" || student_graph_from!="")
		{
			...
			student_graph.open("GET", "../includes/super_admin/get_student_graph.php?dept_id="+dept_id+"&admin_id="+<?php echo $_SESSION['admin_id']; ?>+"&student_graph_from="+student_graph_from+"&student_graph_to="+student_graph_to+"&program_id="+prog_id, true);
			student_graph.send();
		}
	}
