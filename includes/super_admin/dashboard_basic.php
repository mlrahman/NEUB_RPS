...
<script>
	...
	function load_total_students()
	{
		...
		total_students.open("GET", "../includes/super_admin/get_total_students.php?admin_id="+<?php echo $_SESSION['admin_id']; ?>+"&program_id="+prog_id+"&dept_id="+dept_id, true);
		total_students.send();
	}
	//load_total_students();
	...
	function load_graduates()
	{
		...
		graduates.open("GET", "../includes/super_admin/get_graduates.php?dept_id="+dept_id+"&admin_id="+<?php echo $_SESSION['admin_id']; ?>+"&program_id="+prog_id, true);
		graduates.send();
	}
	//load_graduates();
	...
	function load_top_cgpa()
	{
		...
		top_cgpa.open("GET", "../includes/super_admin/get_top_cgpa.php?dept_id="+dept_id+"&admin_id="+<?php echo $_SESSION['admin_id']; ?>+"&program_id="+prog_id, true);
		top_cgpa.send();
	}
	//load_top_cgpa();
	...
	function load_dropouts()
	{
		...
		dropouts.open("GET", "../includes/super_admin/get_dropouts.php?dept_id="+dept_id+"&admin_id="+<?php echo $_SESSION['admin_id']; ?>+"&program_id="+prog_id, true);
		dropouts.send();
	}
	//load_dropouts();
</script>
